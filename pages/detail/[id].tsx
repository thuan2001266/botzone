...
import { ProductItem, toCart } from "../../interface";
          ...
          <div className="w-1/2 ml-2">
            ...
            <div className="bg-[#2f3033] p-6 my-5 rounded-2xl">
              ...
              <ol className="list-disc mx-3">
                <li>
                  Thu cũ Đổi mới: Giảm đến 1.5 triệu (Tuỳ model máy cũ, không áp
                  dụng kèm giảm giá qua cổng thanh toán) Xem chi tiết
                </li>
                <li>
                ...
                <li>
                  Nhập mã SPPMWG giảm 10% tối đa 100.000đ khi thanh toán qua Ví
                  ShopeePay (click xem chi tiết)
                </li>
                <li>
                  {" "}
                  Nhập mã TGDD giảm 4% tối đa 200.000đ cho đơn hàng từ 500.000đ
                  trở lên khi thanh toán qua Ví Moca trên ứng dụng Grab (click
                  xem chi tiết)
                </li>
              </ol>
              <span className="text-sm mt-4">
                (*) Giá hoặc khuyến mãi không áp dụng trả góp lãi suất đặc biệt
                (0%, 0.5%, 1%)
              </span>
            </div>
          </div>
