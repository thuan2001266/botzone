...
function Register() {
  ...
  return (
    <>
      ...
      <div className="w-full h-screen bg-[#3e3e3f] grid place-items-center relative">
        <div
          className={`absolute z-10 w-full h-screen grid place-items-center bg-[#0c0c0d] ${
            loading
        ...
        <div>
          ...
          <div className="sm:w-[520px] md:w-[520px] max-w-[96%] bg-[#323232] m-auto rounded-xl p-5 shadow-2xl mt-4">
